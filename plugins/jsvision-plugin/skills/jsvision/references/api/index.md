...
- [Layout & view system](./layout-views.md) — The `col`/`row`/`stack` DSL, `View`/`Group`, layout props, and the render root. (49 exports)
- [Controls](./controls.md) — Leaf input widgets and the `Input` validators. (32 exports)
...
- [Feedback](./feedback.md) — Progress bars and spinners. (10 exports)
- [Date & color pickers](./date-color.md) — Calendars, date pickers, color swatches, and color pickers. (20 exports)
- [Surfaces & terminal](./surfaces-terminal.md) — Offscreen surfaces and the scrollback terminal view. (8 exports)
- [Text editing](./text-editing.md) — The multi-line `Editor`, `Memo`, and edit-window chrome. (27 exports)
- [App shell](./app-shell.md) — Application, desktop, windows, menus, status line, and the event loop. (44 exports)
- [@jsvision/core — engine, capabilities & themes](./core-essentials.md) — Rendering, terminal capabilities, input, colors, contrast, themes, and safety. (216 exports)
...
- [@jsvision/kanban — responsive terminal task boards](./kanban.md) — Board and viewport composition, generic sources, cards, themes, localization, and application authority. (923 exports)
- [@jsvision/kanban/testing — deterministic interaction harnesses](./kanban-testing.md) — Test-only clocks, host trace replay, dispatcher control, and operation lifecycle evidence. (111 exports)
