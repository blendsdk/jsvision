...
- [Controls](./controls.md) — Leaf input widgets and the `Input` validators. (25 exports)
...
- [App shell](./app-shell.md) — Application, desktop, windows, menus, status line, and the event loop. (40 exports)
- [@jsvision/core — engine, capabilities & themes](./core-essentials.md) — Rendering, terminal capabilities, input, colors, contrast, themes, and safety. (213 exports)
...
- [@jsvision/code-editor — terminal-native source editing](./code-editor.md) — The document model, terminal editor surfaces, language adapters, LSP coordination, themes, safety limits, and observability. (140 exports)
