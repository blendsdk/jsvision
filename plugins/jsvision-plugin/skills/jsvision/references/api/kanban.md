...
```ts
const KANBAN_PHASE_D_ACCELERATOR_MANIFEST: AcceleratorManifest
```
...
```ts
const KANBAN_PHASE_D_ACTION_ENGLISH_MESSAGES: Readonly<{ 'kanban.action.navigation.left.label': string; 'kanban.action.navigation.left.help': string; 'kanban.action.navigation.right.label': string; 'kanban.action.navigation.right.help': string; 'kanban.action.navigation.up.label': string; 'kanban.action.navigation.up.help': string; 'kanban.action.navigation.down.label': string; 'kanban.action.navigation.down.help': string; 'kanban.action.navigation.cell-first.label': string; 'kanban.action.navigation.cell-first.help': string; 'kanban.action.navigation.cell-last.label': string; 'kanban.action.navigation.cell-last.help': string; 'kanban.action.navigation.page-up.label': string; 'kanban.action.navigation.page-up.help': string; 'kanban.action.navigation.page-down.label': string; 'kanban.action.navigation.page-down.help': string; 'kanban.action.navigation.board-first.label': string; 'kanban.action.navigation.board-first.help': string; 'kanban.action.navigation.board-last.label': string; 'kanban.action.navigation.board-last.help': string; 'kanban.action.selection.toggle.label': string; 'kanban.action.selection.toggle.help': string; 'kanban.action.selection.extend-left.label': string; 'kanban.action.selection.extend-left.help': string; 'kanban.action.selection.extend-right.label': string; 'kanban.action.selection.extend-right.help': string; 'kanban.action.selection.extend-up.label': string; 'kanban.action.selection.extend-up.help': string; 'kanban.action.selection.extend-down.label': string; 'kanban.action.selection.extend-down.help': string; 'kanban.action.selection.select-all.label': string; 'kanban.action.selection.select-all.help': string; 'kanban.action.selection.clear.label': string; 'kanban.action.selection.clear.help': string; 'kanban.action.card.open.label': string; 'kanban.action.card.open.help': string; 'kanban.action.card.activate.label': string; 'kanban.action.card.activate.help': string; 'kanban.action.card.create.label': string; 'kanban.action.card.create.help': string; 'kanban.action.card.edit.label': string; 'kanban.action.card.edit.help': string; 'kanban.action.card.duplicate.label': string; 'kanban.action.card.duplicate.help': string; 'kanban.action.card.archive.label': string; 'kanban.action.card.archive.help': string; 'kanban.action.card.delete.label': string; 'kanban.action.card.delete.help': string; 'kanban.action.card.grab.label': string; 'kanban.action.card.grab.help': string; 'kanban.action.card.drop.label': string; 'kanban.action.card.drop.help': string; 'kanban.action.card.move.label': string; 'kanban.action.card.move.help': string; 'kanban.action.card.cancel-move.label': string; 'kanban.action.card.cancel-move.help': string; 'kanban.action.transient.cancel.label': string; 'kanban.action.transient.cancel.help': string; 'kanban.action.column.configure.label': string; 'kanban.action.column.configure.help': string; 'kanban.action.column.add.label': string; 'kanban.action.column.add.help': string; 'kanban.action.column.reorder.label': string; 'kanban.action.column.reorder.help': string; 'kanban.action.column.delete.label': string; 'kanban.action.column.delete.help': string; 'kanban.action.swimlane.configure.label': string; 'kanban.action.swimlane.configure.help': string; 'kanban.action.swimlane.add.label': string; 'kanban.action.swimlane.add.help': string; 'kanban.action.swimlane.reorder.label': string; 'kanban.action.swimlane.reorder.help': string; 'kanban.action.swimlane.delete.label': string; 'kanban.action.swimlane.delete.help': string; 'kanban.action.search.focus.label': string; 'kanban.action.search.focus.help': string; 'kanban.action.filter.clear.label': string; 'kanban.action.filter.clear.help': string; 'kanban.action.sort.configure.label': string; 'kanban.action.sort.configure.help': string; 'kanban.action.view.apply.label': string; 'kanban.action.view.apply.help': string; 'kanban.action.view.save.label': string; 'kanban.action.view.save.help': string; 'kanban.action.context.open.label': string; 'kanban.action.context.open.help': string; 'kanban.action.help.open.label': string; 'kanban.action.help.open.help': string; 'kanban.action.source.retry.label': string; 'kanban.action.source.retry.help': string; 'kanban.action.history.undo.label': string; 'kanban.action.history.undo.help': string; 'kanban.action.history.redo.label': string; 'kanban.action.history.redo.help': string; }>
```
...
```ts
const KANBAN_PHASE_D_ENGLISH_CATALOG: Catalog
```
...
```ts
const KANBAN_PHASE_D_ENGLISH_MESSAGES: Readonly<{ 'kanban.view.search.label': "Search"; 'kanban.view.search.placeholder': "Find cards"; 'kanban.view.quick-filters': "Quick filters"; 'kanban.view.sort': "Sort"; 'kanban.view.saved-views': "Views"; 'kanban.view.clear': "Clear"; 'kanban.view.overflow': "More"; 'kanban.view.visible-count': "Visible cards"; 'kanban.view.matching-count': "Matching cards"; 'kanban.editor.create.title': "Create card"; 'kanban.editor.view.title': "View card"; 'kanban.editor.edit.title': "Edit card"; 'kanban.editor.action.save': "~S~ave"; 'kanban.editor.action.reload': "~R~eload"; 'kanban.editor.action.cancel': "~C~ancel"; 'kanban.editor.action.close': "~C~lose"; 'kanban.editor.confirm.discard-draft': "Discard unsaved changes?"; 'kanban.editor.confirm.reload-stale': "Reload and discard local changes?"; 'kanban.editor.status.stale': "Card changed · Reload"; 'kanban.editor.status.deleted': "Card was deleted"; 'kanban.editor.status.unavailable': "Card is unavailable"; 'kanban.editor.status.validating': "Validating…"; 'kanban.editor.status.saving': "Saving…"; 'kanban.editor.status.awaiting': "Waiting for board update…"; 'kanban.editor.status.rejected': "Change rejected"; 'kanban.editor.status.saved': "Saved"; 'kanban.editor.status.unsaved': "Unsaved changes"; 'kanban.editor.status.ready': "Ready"; 'kanban.editor.status.result-failed': "Unable to prepare result"; 'kanban.editor.control-unavailable': "Control unavailable"; 'kanban.editor.validation.invalid-standard-field': "Invalid value"; 'kanban.editor.section.main': "Main"; 'kanban.editor.section.details': "Details"; 'kanban.editor.section.people': "People"; 'kanban.editor.section.checklists': "Checklists"; 'kanban.editor.field.title': "Title"; 'kanban.editor.field.status': "Status"; 'kanban.editor.field.description': "Description"; 'kanban.editor.field.type': "Type"; 'kanban.editor.field.priority': "Priority"; 'kanban.editor.field.assignees': "Assignees"; 'kanban.editor.field.labels': "Labels"; 'kanban.editor.field.start-date': "Start date"; 'kanban.editor.field.due-date': "Due date"; 'kanban.editor.field.estimate': "Estimate"; 'kanban.editor.field.checklists': "Checklists"; 'kanban.configuration.column.add.title': "Add column"; 'kanban.configuration.column.update.title': "Edit column"; 'kanban.configuration.column.reorder.title': "Reorder column"; 'kanban.configuration.column.delete.title': "Delete column"; 'kanban.configuration.swimlane.add.title': "Add swimlane"; 'kanban.configuration.swimlane.update.title': "Edit swimlane"; 'kanban.configuration.swimlane.reorder.title': "Reorder swimlane"; 'kanban.configuration.swimlane.delete.title': "Delete swimlane"; 'kanban.configuration.action.apply': "~A~pply"; 'kanban.configuration.action.reload': "~R~eload"; 'kanban.configuration.action.cancel': "~C~ancel"; 'kanban.configuration.confirm.delete': "Delete this structure?"; 'kanban.configuration.confirm.discard-draft': "Discard unsaved changes?"; 'kanban.configuration.confirm.reload-stale': "Reload and discard local changes?"; 'kanban.configuration.status.stale': "Structure changed · Reload"; 'kanban.configuration.status.unavailable': "Structure unavailable"; 'kanban.configuration.status.saving': "Applying…"; 'kanban.configuration.status.awaiting-publication': "Waiting for board update…"; 'kanban.configuration.status.applied': "Applied"; 'kanban.configuration.status.unsaved': "Unsaved changes"; 'kanban.configuration.status.ready': "Ready"; 'kanban.configuration.edit.help': "Edit the isolated draft, then Apply or Cancel."; 'kanban.configuration.reorder.help': "Choose a stable neighbor, then Apply."; 'kanban.configuration.reorder.start': "Start"; 'kanban.configuration.reorder.end': "End"; 'kanban.configuration.reorder.between': "Between"; 'kanban.configuration.reorder.before': "Before"; 'kanban.configuration.reorder.after': "After"; 'kanban.configuration.reorder.destinations': "Choose destination:"; 'kanban.configuration.field.name': "~N~ame"; 'kanban.configuration.field.disambiguator': "~Q~ualifier"; 'kanban.configuration.field.done-summary': "Done ~s~ummary"; 'kanban.configuration.field.done-details': "Done de~t~ails"; 'kanban.configuration.field.wip-minimum': "WIP m~i~n"; 'kanban.configuration.field.wip-maximum': "WIP ma~x~"; 'kanban.configuration.field.wip-mode': "WIP m~o~de"; 'kanban.configuration.field.wip-count-done': "Count ~d~one"; 'kanban.configuration.field.style': "Style ~r~ole"; 'kanban.configuration.field.data': "App ~m~etadata"; 'kanban.configuration.delete.occupancy-unknown': "Affected cards: unknown"; 'kanban.configuration.delete.affected': "Affected cards"; 'kanban.configuration.delete.no-policy': "No reassignment policy"; 'kanban.configuration.delete.policy-ready': "Atomic policy configured"; 'kanban.configuration.delete.destination': "Move affected cards to:"; 'kanban.action.navigation.left.label': string; 'kanban.action.navigation.left.help': string; 'kanban.action.navigation.right.label': string; 'kanban.action.navigation.right.help': string; 'kanban.action.navigation.up.label': string; 'kanban.action.navigation.up.help': string; 'kanban.action.navigation.down.label': string; 'kanban.action.navigation.down.help': string; 'kanban.action.navigation.cell-first.label': string; 'kanban.action.navigation.cell-first.help': string; 'kanban.action.navigation.cell-last.label': string; 'kanban.action.navigation.cell-last.help': string; 'kanban.action.navigation.page-up.label': string; 'kanban.action.navigation.page-up.help': string; 'kanban.action.navigation.page-down.label': string; 'kanban.action.navigation.page-down.help': string; 'kanban.action.navigation.board-first.label': string; 'kanban.action.navigation.board-first.help': string; 'kanban.action.navigation.board-last.label': string; 'kanban.action.navigation.board-last.help': string; 'kanban.action.selection.toggle.label': string; 'kanban.action.selection.toggle.help': string; 'kanban.action.selection.extend-left.label': string; 'kanban.action.selection.extend-left.help': string; 'kanban.action.selection.extend-right.label': string; 'kanban.action.selection.extend-right.help': string; 'kanban.action.selection.extend-up.label': string; 'kanban.action.selection.extend-up.help': string; 'kanban.action.selection.extend-down.label': string; 'kanban.action.selection.extend-down.help': string; 'kanban.action.selection.select-all.label': string; 'kanban.action.selection.select-all.help': string; 'kanban.action.selection.clear.label': string; 'kanban.action.selection.clear.help': string; 'kanban.action.card.open.label': string; 'kanban.action.card.open.help': string; 'kanban.action.card.activate.label': string; 'kanban.action.card.activate.help': string; 'kanban.action.card.create.label': string; 'kanban.action.card.create.help': string; 'kanban.action.card.edit.label': string; 'kanban.action.card.edit.help': string; 'kanban.action.card.duplicate.label': string; 'kanban.action.card.duplicate.help': string; 'kanban.action.card.archive.label': string; 'kanban.action.card.archive.help': string; 'kanban.action.card.delete.label': string; 'kanban.action.card.delete.help': string; 'kanban.action.card.grab.label': string; 'kanban.action.card.grab.help': string; 'kanban.action.card.drop.label': string; 'kanban.action.card.drop.help': string; 'kanban.action.card.move.label': string; 'kanban.action.card.move.help': string; 'kanban.action.card.cancel-move.label': string; 'kanban.action.card.cancel-move.help': string; 'kanban.action.transient.cancel.label': string; 'kanban.action.transient.cancel.help': string; 'kanban.action.column.configure.label': string; 'kanban.action.column.configure.help': string; 'kanban.action.column.add.label': string; 'kanban.action.column.add.help': string; 'kanban.action.column.reorder.label': string; 'kanban.action.column.reorder.help': string; 'kanban.action.column.delete.label': string; 'kanban.action.column.delete.help': string; 'kanban.action.swimlane.configure.label': string; 'kanban.action.swimlane.configure.help': string; 'kanban.action.swimlane.add.label': string; 'kanban.action.swimlane.add.help': string; 'kanban.action.swimlane.reorder.label': string; 'kanban.action.swimlane.reorder.help': string; 'kanban.action.swimlane.delete.label': string; 'kanban.action.swimlane.delete.help': string; 'kanban.action.search.focus.label': string; 'kanban.action.search.focus.help': string; 'kanban.action.filter.clear.label': string; 'kanban.action.filter.clear.help': string; 'kanban.action.sort.configure.label': string; 'kanban.action.sort.configure.help': string; 'kanban.action.view.apply.label': string; 'kanban.action.view.apply.help': string; 'kanban.action.view.save.label': string; 'kanban.action.view.save.help': string; 'kanban.action.context.open.label': string; 'kanban.action.context.open.help': string; 'kanban.action.help.open.label': string; 'kanban.action.help.open.help': string; 'kanban.action.source.retry.label': string; 'kanban.action.source.retry.help': string; 'kanban.action.history.undo.label': string; 'kanban.action.history.undo.help': string; 'kanban.action.history.redo.label': string; 'kanban.action.history.redo.help': string; }>
```
...
```ts
const KANBAN_PHASE_D_UI_ENGLISH_MESSAGES: Readonly<{ 'kanban.view.search.label': "Search"; 'kanban.view.search.placeholder': "Find cards"; 'kanban.view.quick-filters': "Quick filters"; 'kanban.view.sort': "Sort"; 'kanban.view.saved-views': "Views"; 'kanban.view.clear': "Clear"; 'kanban.view.overflow': "More"; 'kanban.view.visible-count': "Visible cards"; 'kanban.view.matching-count': "Matching cards"; 'kanban.editor.create.title': "Create card"; 'kanban.editor.view.title': "View card"; 'kanban.editor.edit.title': "Edit card"; 'kanban.editor.action.save': "~S~ave"; 'kanban.editor.action.reload': "~R~eload"; 'kanban.editor.action.cancel': "~C~ancel"; 'kanban.editor.action.close': "~C~lose"; 'kanban.editor.confirm.discard-draft': "Discard unsaved changes?"; 'kanban.editor.confirm.reload-stale': "Reload and discard local changes?"; 'kanban.editor.status.stale': "Card changed · Reload"; 'kanban.editor.status.deleted': "Card was deleted"; 'kanban.editor.status.unavailable': "Card is unavailable"; 'kanban.editor.status.validating': "Validating…"; 'kanban.editor.status.saving': "Saving…"; 'kanban.editor.status.awaiting': "Waiting for board update…"; 'kanban.editor.status.rejected': "Change rejected"; 'kanban.editor.status.saved': "Saved"; 'kanban.editor.status.unsaved': "Unsaved changes"; 'kanban.editor.status.ready': "Ready"; 'kanban.editor.status.result-failed': "Unable to prepare result"; 'kanban.editor.control-unavailable': "Control unavailable"; 'kanban.editor.validation.invalid-standard-field': "Invalid value"; 'kanban.editor.section.main': "Main"; 'kanban.editor.section.details': "Details"; 'kanban.editor.section.people': "People"; 'kanban.editor.section.checklists': "Checklists"; 'kanban.editor.field.title': "Title"; 'kanban.editor.field.status': "Status"; 'kanban.editor.field.description': "Description"; 'kanban.editor.field.type': "Type"; 'kanban.editor.field.priority': "Priority"; 'kanban.editor.field.assignees': "Assignees"; 'kanban.editor.field.labels': "Labels"; 'kanban.editor.field.start-date': "Start date"; 'kanban.editor.field.due-date': "Due date"; 'kanban.editor.field.estimate': "Estimate"; 'kanban.editor.field.checklists': "Checklists"; 'kanban.configuration.column.add.title': "Add column"; 'kanban.configuration.column.update.title': "Edit column"; 'kanban.configuration.column.reorder.title': "Reorder column"; 'kanban.configuration.column.delete.title': "Delete column"; 'kanban.configuration.swimlane.add.title': "Add swimlane"; 'kanban.configuration.swimlane.update.title': "Edit swimlane"; 'kanban.configuration.swimlane.reorder.title': "Reorder swimlane"; 'kanban.configuration.swimlane.delete.title': "Delete swimlane"; 'kanban.configuration.action.apply': "~A~pply"; 'kanban.configuration.action.reload': "~R~eload"; 'kanban.configuration.action.cancel': "~C~ancel"; 'kanban.configuration.confirm.delete': "Delete this structure?"; 'kanban.configuration.confirm.discard-draft': "Discard unsaved changes?"; 'kanban.configuration.confirm.reload-stale': "Reload and discard local changes?"; 'kanban.configuration.status.stale': "Structure changed · Reload"; 'kanban.configuration.status.unavailable': "Structure unavailable"; 'kanban.configuration.status.saving': "Applying…"; 'kanban.configuration.status.awaiting-publication': "Waiting for board update…"; 'kanban.configuration.status.applied': "Applied"; 'kanban.configuration.status.unsaved': "Unsaved changes"; 'kanban.configuration.status.ready': "Ready"; 'kanban.configuration.edit.help': "Edit the isolated draft, then Apply or Cancel."; 'kanban.configuration.reorder.help': "Choose a stable neighbor, then Apply."; 'kanban.configuration.reorder.start': "Start"; 'kanban.configuration.reorder.end': "End"; 'kanban.configuration.reorder.between': "Between"; 'kanban.configuration.reorder.before': "Before"; 'kanban.configuration.reorder.after': "After"; 'kanban.configuration.reorder.destinations': "Choose destination:"; 'kanban.configuration.field.name': "~N~ame"; 'kanban.configuration.field.disambiguator': "~Q~ualifier"; 'kanban.configuration.field.done-summary': "Done ~s~ummary"; 'kanban.configuration.field.done-details': "Done de~t~ails"; 'kanban.configuration.field.wip-minimum': "WIP m~i~n"; 'kanban.configuration.field.wip-maximum': "WIP ma~x~"; 'kanban.configuration.field.wip-mode': "WIP m~o~de"; 'kanban.configuration.field.wip-count-done': "Count ~d~one"; 'kanban.configuration.field.style': "Style ~r~ole"; 'kanban.configuration.field.data': "App ~m~etadata"; 'kanban.configuration.delete.occupancy-unknown': "Affected cards: unknown"; 'kanban.configuration.delete.affected': "Affected cards"; 'kanban.configuration.delete.no-policy': "No reassignment policy"; 'kanban.configuration.delete.policy-ready': "Atomic policy configured"; 'kanban.configuration.delete.destination': "Move affected cards to:"; }>
```
...
## KanbanPhaseDActionMessageId

Stable action label/help message identities derived from the complete package action inventory.

```ts
type KanbanPhaseDActionMessageId = KanbanPackageActionId extends `kanban.${infer TStem}`
  ? `kanban.action.${TStem}.${'label' | 'help'}`
  : never
```

## KanbanPhaseDMessageMap

Complete typed English message contract introduced by Phase D productivity workflows.

```ts
type KanbanPhaseDMessageMap = Readonly<Record<KanbanPhaseDActionMessageId, Message>> & {
