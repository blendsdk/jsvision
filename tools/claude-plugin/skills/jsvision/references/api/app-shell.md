...
interface EventLoop {
  ...
  focusNext(): void;   // Move focus to the next focusable view in traversal order, wrapping at the end.
  focusPrev(): void;   // Move focus to the previous focusable view in traversal order, wrapping at the start.
