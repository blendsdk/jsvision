...
packages/ui/             @jsvision/ui — the Turbo Vision-style widget framework (retained tree + signals) on @jsvision/core. Single public entry src/index.ts re-exports each landed subsystem (layout uses EXPLICIT named re-exports, not export *): src/layout/ (ADR-008/RD-02 cell-native layout engine — see below) and src/reactive/ (RD-01 reactive core — see below). private until first release; remaining subsystems land per codeops/features/jsvision-ui/plans/tui-ui/01-component-map.md.
