...
> **Features**: 0 / 4 done · datagrid (RD-10 navigation & interaction done — 11/15 RDs; RD-12 validation & lifecycle executing) + jsvision-forms reopened (first slice shipped; extended with showcase + follow-on slices)
