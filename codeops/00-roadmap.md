...
| docs-website | [→](features/docs-website/00-roadmap.md) | RD-01/02/03/06 ✅ Done (site-foundation · @jsvision/web runtime · live-example system · TypeDoc API ref) · RD-04/05/07…10 ✏️ drafted | 4/10 RDs · RD-06 ✅ done | 🔄 | 2026-07-11 |
| jsvision-plugin | [→](features/jsvision-plugin/00-roadmap.md) | PL-01 ✅ Done (plugin: skill + scaffolder + recipes + gate) · PL-02 ✅ Done (plugin-self-sync drift auto-updater) | 2/2 plans | ✅ | 2026-07-11 |
