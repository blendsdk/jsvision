...
> **Features**: 0 / 4 done · datagrid (RD-08 rows & selection done — 9/15 RDs) + jsvision-forms reopened (first slice shipped; extended with showcase + follow-on slices)
...
| datagrid | [→](features/datagrid/00-roadmap.md) | RD-01…RD-04 ✅ Done (foundation · editing-engine · cell-editors · formatting-rendering) · RD-05 ✅ Done (sorting) · RD-06 ✅ Done (filtering) · RD-07 ✅ Done (columns & layout — 58 tasks / 7 phases) · RD-08 ✅ Done (rows & selection — 50 tasks / 6 phases) · RD-09 🔄 Executing (footer, aggregation & master-detail — 47 tasks / 6 phases; editable write-through master-detail; exec_plan started 2026-07-17 `--auto-commit`) · RD-10…RD-14 🔎 RD Preflighted · RD-15 ✅ Done (showcase app — 51 demos) | 9/15 RDs | 🔄 | 2026-07-17 |
