...
> **Features**: 1 / 4 done · split-panes ✅ complete (SplitView shipped on feat/split-panes, PR-ready) · follow-ups plan ✅ done (grab-mark toggle · scroll-in-pane demo · amiga-clock split window) · jsvision-forms reopened (first slice shipped; extended with showcase + follow-on slices)
