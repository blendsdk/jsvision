...
> **Features**: 1 / 4 done · split-panes ✅ complete (SplitView shipped on feat/split-panes, PR-ready) · jsvision-forms reopened (first slice shipped; extended with showcase + follow-on slices)
