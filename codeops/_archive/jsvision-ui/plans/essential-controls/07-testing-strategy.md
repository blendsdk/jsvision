...
| **ST-07** | Validators (03-04) | `filter('0-9')`, `range(0,100)`, `range(-50,50)`, `lookup(['red'])` | `filter.isValidInput('5')`=T, `('a')`=F; `range(0,100).isValidInput('1')`=T, `('+')`=T, `('-')`=**F** (unsigned), `.isValid('150')`=F, `('50')`=T; `range(-50,50).isValidInput('-')`=T (signed); `lookup.isValidInput('x')`=T, `.isValid('blue')`=F, `('red')`=T | AC-5 · PA-12/**PA-15** |
