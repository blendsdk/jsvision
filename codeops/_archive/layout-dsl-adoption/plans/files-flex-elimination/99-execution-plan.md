...
- [x] 7.3 Full `yarn verify` + `check:deps`; open the PR citing RD-01 for every re-derived oracle ✅ (completed: 2026-07-19 21:25) — [PR #125](https://github.com/blendsdk/jsvision/pull/125), base `feat/dsl-adoptation` (retarget to `develop` once #123 lands)
