...
| Merge conflict with PR #127/#128 | ~~Medium~~ **materialised** | Low | #127 merged 2026-07-20 and #128 went `CONFLICTING` — in exactly **one** file, `features/layout-dsl-adoption/00-roadmap.md`, resolved as a union. Zero source conflicts, as predicted: this plan's six source files are verified disjoint from #127's diff |
