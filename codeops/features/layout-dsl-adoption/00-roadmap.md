...
> **Progress**: 4 / 12 issues done (#113 · #122 · #115 · #120) · requirements: RD-01/RD-02 ✏️ drafted · plans: [tier0-parity-safe](plans/tier0-parity-safe/00-index.md) ✅ done (Tier-0 MVP — 12/12) · [focus-traversal-primitive](plans/focus-traversal-primitive/00-index.md) ✅ done (exec_plan 11/11, GH #122) · [flex-dialog-bodies](plans/flex-dialog-bodies/00-index.md) ✅ done 2026-07-19 (exec_plan 14/14) (#115 Tier-2 ui/forms dialog bodies — #122 unblocked) · [files-flex-elimination](plans/files-flex-elimination/00-index.md) ✅ done 2026-07-19 (exec_plan 27/27, PR #125) (#120 Tier-2 files dialogs + grow-mode deletion) · [widget-flex-adoption](plans/widget-flex-adoption/00-index.md) 🔄 executing (started 2026-07-19) (#109 + #116 combined — 48 behavior-preserving conversions across 10 files + 3 preserved public-receiver sites; first slice outside the RD-01 divergence set; preflight found 27 items incl. 1 CRITICAL, all resolved, and narrowed `grid-panels` 23→15 back toward the issue's filed scope)
...
| [#109](https://github.com/blendsdk/jsvision/issues/109) | ui widgets — data-grid / tab-view / application | Port | 🔄 | behavior-preserving; split-view already done. Plan [widget-flex-adoption](plans/widget-flex-adoption/00-index.md) 🔬 preflighted 2026-07-19 ([report](plans/widget-flex-adoption/00-preflight-report.md) — 27 findings, all resolved) — 12 conversions in 3 files. **Scope corrected:** `application.ts` yields **one** conversion, not the ~6 the sweep claimed — `:335`/`:435` are the T-AO1 hidden-host overlay (won't-do), `:347`/`:353` belong to #117, and `:330` is preserved as a public-API clobber contract (AR-1/AR-9) |
