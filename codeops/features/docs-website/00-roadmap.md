...
| RD-08 | Reference, Guide curriculum & trust content | [RD-08](requirements/RD-08-reference-trust.md) | [guide-course-system](plans/guide-course-system/00-index.md) | Executing | 🔄 | 2026-07-30 | 152/246 tasks · Phase 19 Running in the browser is Complete after 33/33 focused Guide checks, 8/8 browser-runtime checks, production docs build, plugin synchronization, independent review, final no-third-review corrections, and authoritative verification. Phase 20 Writing your own widget is next. Separate Reference/trust planning remains for architecture · FAQ · a11y · security · perf · compat · theming gallery · versioning · contributing. |
