...
| RD-08 | Reference, Guide curriculum & trust content | [RD-08](requirements/RD-08-reference-trust.md) | [guide-course-system](plans/guide-course-system/00-index.md) | Executing | 🔄 | 2026-07-29 | 39/246 tasks · Codex plugin hardening is 18/18 focused green with real/synthetic distribution drift and independent stale-version diagnostics; `yarn verify` passes. Route promotion and curriculum synchronization are next. Separate Reference/trust planning remains for architecture · FAQ · a11y · security · perf · compat · theming gallery · versioning · contributing. |
