...
| RD-08 | Reference, Guide curriculum & trust content | [RD-08](requirements/RD-08-reference-trust.md) | [guide-course-system](plans/guide-course-system/00-index.md) | Executing | 🔄 | 2026-07-30 | 96/246 tasks · Phase 12 Dialogs & modality is Complete after RV-012-001 was corrected without waiver, 24/24 focused checks and every authoritative gate passed, and the permitted re-review cleared all findings. Phase 13 Async work is next. Separate Reference/trust planning remains for architecture · FAQ · a11y · security · perf · compat · theming gallery · versioning · contributing. |
