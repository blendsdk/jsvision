...
| RD-08 | Reference, Guide curriculum & trust content | [RD-08](requirements/RD-08-reference-trust.md) | [guide-course-system](plans/guide-course-system/00-index.md) | Executing | 🔄 | 2026-07-30 | 48/246 tasks · Views & focus is Complete after all four Major and three Minor review findings were corrected, 35/35 focused tests and every authoritative gate passed, and the permitted re-review cleared all findings. Phase 7 Events, commands & keymaps is next. Separate Reference/trust planning remains for architecture · FAQ · a11y · security · perf · compat · theming gallery · versioning · contributing. |
