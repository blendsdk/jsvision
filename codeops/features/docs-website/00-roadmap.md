...
| RD-08 | Reference, Guide curriculum & trust content | [RD-08](requirements/RD-08-reference-trust.md) | [guide-course-system](plans/guide-course-system/00-index.md) | Executing | 🔄 | 2026-07-30 | 216/246 tasks · Phase 27 Terminal capabilities & portability is complete after 42 focused checks, docs-site typecheck and DOM tests, production docs build, authoritative verification, and the permitted fix-scoped review; Phase 28 In production is next. Separate Reference/trust planning remains for architecture · FAQ · a11y · security · perf · compat · theming gallery · versioning · contributing. |
