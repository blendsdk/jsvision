...
| RD-08 | Reference, Guide curriculum & trust content | [RD-08](requirements/RD-08-reference-trust.md) | [guide-course-system](plans/guide-course-system/00-index.md) | Executing | 🔄 | 2026-07-30 | 232/246 tasks · Phase 29 Build a complete application is complete with two authentic template1 capstone labs, 39 focused course/catalog checks, production docs build, authoritative verification, and the permitted fix-scoped review; Phase 30 specialist-course boundary is next. Separate Reference/trust planning remains for architecture · FAQ · a11y · security · perf · compat · theming gallery · versioning · contributing. |
