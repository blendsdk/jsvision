...
| RD-08 | Reference, Guide curriculum & trust content | [RD-08](requirements/RD-08-reference-trust.md) | [guide-course-system](plans/guide-course-system/00-index.md) | Executing | 🔄 | 2026-07-29 | 8/246 tasks · Introduction is Complete after independent review, real intermediate dialog-resize correction, 19/19 focused tests, and `yarn verify`; Install & packages is next. Separate Reference/trust planning remains for architecture · FAQ · a11y · security · perf · compat · theming gallery · versioning · contributing. |
