...
| RD-08 | Reference, Guide curriculum & trust content | [RD-08](requirements/RD-08-reference-trust.md) | [guide-course-system](plans/guide-course-system/00-index.md) | Executing | 🔄 | 2026-07-30 | 54/246 tasks · Events, commands & keymaps reached its green checkpoint with 23/23 specifications, docs-site typecheck, registry integration, and authoritative `yarn verify`; implementation hardening is next. Separate Reference/trust planning remains for architecture · FAQ · a11y · security · perf · compat · theming gallery · versioning · contributing. |
