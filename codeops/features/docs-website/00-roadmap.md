...
| RD-08 | Reference, Guide curriculum & trust content | [RD-08](requirements/RD-08-reference-trust.md) | [guide-course-system](plans/guide-course-system/00-index.md) | Executing | 🔄 | 2026-07-30 | 88/246 tasks · Phase 11 The application shell is Complete after all review corrections, 34/34 Guide checks, 15/15 focused UI checks, docs-site typecheck, production build, plugin integrity, and authoritative `yarn verify` passed. Separate Reference/trust planning remains for architecture · FAQ · a11y · security · perf · compat · theming gallery · versioning · contributing. |
