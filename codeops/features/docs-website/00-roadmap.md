...
| RD-08 | Reference, Guide curriculum & trust content | [RD-08](requirements/RD-08-reference-trust.md) | [guide-course-system](plans/guide-course-system/00-index.md) | Executing | 🔄 | 2026-07-30 | 192/246 tasks · Phase 24 Crash safety is complete after 43 focused checks, docs-site typecheck, production docs build, authoritative verification, and the permitted fix-scoped review; Phase 25 Displaying untrusted text safely is next. Separate Reference/trust planning remains for architecture · FAQ · a11y · security · perf · compat · theming gallery · versioning · contributing. |
