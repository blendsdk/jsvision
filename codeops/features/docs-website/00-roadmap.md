...
| RD-08 | Reference, Guide curriculum & trust content | [RD-08](requirements/RD-08-reference-trust.md) | [guide-course-system](plans/guide-course-system/00-index.md) | Executing | 🔄 | 2026-07-30 | 47/246 tasks · Views & focus hardening passes 26/26 focused tests, docs-site typecheck, and `yarn verify` across retained order, eligibility fallback, modal restoration, responsive geometry, and cleanup; promotion remains. Separate Reference/trust planning remains for architecture · FAQ · a11y · security · perf · compat · theming gallery · versioning · contributing. |
