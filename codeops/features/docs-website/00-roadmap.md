...
| RD-08 | Reference, Guide curriculum & trust content | [RD-08](requirements/RD-08-reference-trust.md) | [guide-course-system](plans/guide-course-system/00-index.md) | Executing | 🔄 | 2026-07-30 | 176/246 tasks · Phase 22 Application architecture & best practices is Complete after two template1 labs, lifecycle hardening, 32 focused checks, docs-site typecheck, production docs build, permitted re-review, and authoritative verification passed; commit is next. Separate Reference/trust planning remains for architecture · FAQ · a11y · security · perf · compat · theming gallery · versioning · contributing. |
