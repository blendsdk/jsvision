...
| RD-08 | Reference, Guide curriculum & trust content | [RD-08](requirements/RD-08-reference-trust.md) | [guide-course-system](plans/guide-course-system/00-index.md) | Executing | 🔄 | 2026-07-30 | 56/246 tasks · Phase 7 is complete: AR-30 corrections pass 38/38 focused tests and every authoritative gate in the final promoted state; the permitted re-review cleared all four Major and two Minor findings. Phase 8 Keyboard & clipboard is next. Separate Reference/trust planning remains for architecture · FAQ · a11y · security · perf · compat · theming gallery · versioning · contributing. |
