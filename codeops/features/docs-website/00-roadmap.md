...
| RD-08 | Reference, Guide curriculum & trust content | [RD-08](requirements/RD-08-reference-trust.md) | [guide-course-system](plans/guide-course-system/00-index.md) | Executing | 🔄 | 2026-07-30 | 63/246 tasks · Phase 8 Keyboard & clipboard hardening is verified with 33/33 focused checks and authoritative verification passing; catalog promotion, curriculum-map synchronization, and final phase review remain. Separate Reference/trust planning remains for architecture · FAQ · a11y · security · perf · compat · theming gallery · versioning · contributing. |
