...
| RD-08 | Reference, Guide curriculum & trust content | [RD-08](requirements/RD-08-reference-trust.md) | [guide-course-system](plans/guide-course-system/00-index.md) | Executing | 🔄 | 2026-07-30 | 104/246 tasks · Phase 13 Async work, cancellation & progress is Complete after authentic pending-controller cancellation evidence, 27/27 focused checks, production docs build, authoritative verification, and the permitted re-review cleared every finding. Phase 14 Forms is next. Separate Reference/trust planning remains for architecture · FAQ · a11y · security · perf · compat · theming gallery · versioning · contributing. |
