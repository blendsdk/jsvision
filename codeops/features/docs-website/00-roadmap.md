...
| RD-08 | Reference, Guide curriculum & trust content | [RD-08](requirements/RD-08-reference-trust.md) | [guide-course-system](plans/guide-course-system/00-index.md) | Executing | 🔄 | 2026-07-30 | 136/246 tasks · Phase 17 Screens & routing is Complete after 30/30 focused checks, production docs build, independent review, final no-third-review corrections, and authoritative verification. Phase 18 Theming & colour depth is next. Separate Reference/trust planning remains for architecture · FAQ · a11y · security · perf · compat · theming gallery · versioning · contributing. |
