...
| RD-08 | Reference, Guide curriculum & trust content | [RD-08](requirements/RD-08-reference-trust.md) | [guide-course-system](plans/guide-course-system/00-index.md) | Executing | 🔄 | 2026-07-30 | 64/246 tasks · Phase 8 Keyboard & clipboard is Complete after AR-33 corrections, 44/44 focused checks, docs-site typecheck, production docs build, plugin integrity, authoritative verification, and the one permitted re-review cleared every Critical and Major finding. Phase 9 Text, Unicode & terminal cells is next. Separate Reference/trust planning remains for architecture · FAQ · a11y · security · perf · compat · theming gallery · versioning · contributing. |
