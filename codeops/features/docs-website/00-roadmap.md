...
| RD-08 | Reference, Guide curriculum & trust content | [RD-08](requirements/RD-08-reference-trust.md) | [guide-course-system](plans/guide-course-system/00-index.md) | Executing | 🔄 | 2026-07-30 | 80/246 tasks · Phase 10 Scrolling, lists & large content is Complete after all review corrections, 39/39 focused checks, docs-site typecheck, production build, plugin integrity, and authoritative `yarn verify` passed. Separate Reference/trust planning remains for architecture · FAQ · a11y · security · perf · compat · theming gallery · versioning · contributing. |
