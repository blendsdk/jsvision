...
| RD-08 | Reference, Guide curriculum & trust content | [RD-08](requirements/RD-08-reference-trust.md) | [guide-course-system](plans/guide-course-system/00-index.md) | Executing | 🔄 | 2026-07-29 | 30/246 tasks · Reactive state reached its green checkpoint with 15/15 reconciled specifications, docs-site typecheck, and `yarn verify`; lifecycle hardening is next. Separate Reference/trust planning remains for architecture · FAQ · a11y · security · perf · compat · theming gallery · versioning · contributing. |
