...
| RD-08 | Reference, Guide curriculum & trust content | [RD-08](requirements/RD-08-reference-trust.md) | [guide-course-system](plans/guide-course-system/00-index.md) | Executing | 🔄 | 2026-07-30 | 238/246 tasks · Phase 30 specialist-course boundary is complete with bidirectional prerequisite links, no duplicate Guide routes, 49 focused navigation/topology checks, production docs build, authoritative verification, and independent review; Phase 31 curriculum integration is next. Separate Reference/trust planning remains for architecture · FAQ · a11y · security · perf · compat · theming gallery · versioning · contributing. |
