...
| RD-08 | Reference, Guide curriculum & trust content | [RD-08](requirements/RD-08-reference-trust.md) | [guide-course-system](plans/guide-course-system/00-index.md) | Executing | 🔄 | 2026-07-30 | 40/246 tasks · Codex plugin is Complete and synchronized across its catalog entry, learner-facing curriculum, focused oracle, production docs build, plugin integrity, and `yarn verify`. The independent Phase 5 quality review is next. Separate Reference/trust planning remains for architecture · FAQ · a11y · security · perf · compat · theming gallery · versioning · contributing. |
