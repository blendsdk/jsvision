...
| RD-08 | Reference, Guide curriculum & trust content | [RD-08](requirements/RD-08-reference-trust.md) | [guide-course-system](plans/guide-course-system/00-index.md) | Executing | 🔄 | 2026-07-29 | 14/246 tasks · Install & packages is 8/8 focused green with manifest, compiler, export-map, and doctor evidence; docs-site typecheck and `yarn verify` pass. Hardening is next. Separate Reference/trust planning remains for architecture · FAQ · a11y · security · perf · compat · theming gallery · versioning · contributing. |
