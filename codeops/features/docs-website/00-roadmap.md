...
| RD-08 | Reference, Guide curriculum & trust content | [RD-08](requirements/RD-08-reference-trust.md) | [guide-course-system](plans/guide-course-system/00-index.md) | Executing | 🔄 | 2026-07-30 | 46/246 tasks · Views & focus course and its two template1 labs are green across 19 focused assertions, docs-site typecheck, registry integration, and `yarn verify`; implementation hardening and promotion remain. Separate Reference/trust planning remains for architecture · FAQ · a11y · security · perf · compat · theming gallery · versioning · contributing. |
