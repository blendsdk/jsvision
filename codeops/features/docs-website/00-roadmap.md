...
| RD-08 | Reference, Guide curriculum & trust content | [RD-08](requirements/RD-08-reference-trust.md) | [guide-course-system](plans/guide-course-system/00-index.md) | Executing | 🔄 | 2026-07-30 | 55/246 tasks · Events, commands & keymaps passes 29/29 focused tests plus docs-site typecheck and authoritative `yarn verify`; promotion and mandatory Phase 7 review remain. Separate Reference/trust planning remains for architecture · FAQ · a11y · security · perf · compat · theming gallery · versioning · contributing. |
