...
| RD-08 | Reference, Guide curriculum & trust content | [RD-08](requirements/RD-08-reference-trust.md) | [guide-course-system](plans/guide-course-system/00-index.md) | Executing | 🔄 | 2026-07-30 | 224/246 tasks · Phase 28 In production is complete with authentic supervision/readiness/diagnostic artifacts, 74 focused course and inherited-regression checks, production docs build, authoritative verification, and the permitted fix-scoped review; Phase 29 Build a complete application is next. Separate Reference/trust planning remains for architecture · FAQ · a11y · security · perf · compat · theming gallery · versioning · contributing. |
