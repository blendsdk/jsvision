...
| RD-08 | Reference, Guide curriculum & trust content | [RD-08](requirements/RD-08-reference-trust.md) | [guide-course-system](plans/guide-course-system/00-index.md) | Executing | 🔄 | 2026-07-30 | 120/246 tasks · Phase 15 Files & the FileSystem seam is Complete after 32/32 focused checks, production docs build, source-grounded link correction, and review remediation accepted all findings without waiver. Phase 16 Internationalization is next. Separate Reference/trust planning remains for architecture · FAQ · a11y · security · perf · compat · theming gallery · versioning · contributing. |
