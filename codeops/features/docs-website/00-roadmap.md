...
| RD-08 | Reference, Guide curriculum & trust content | [RD-08](requirements/RD-08-reference-trust.md) | [guide-course-system](plans/guide-course-system/00-index.md) | Executing | 🔄 | 2026-07-30 | 72/246 tasks · Phase 9 Text, Unicode & terminal cells is Complete with two deterministic labs; 47/47 focused checks, docs build, plugin integrity, authoritative `yarn verify`, and the clean fix-scoped re-review pass. Phase 10 Scrolling, lists & large content is next. Separate Reference/trust planning remains for architecture · FAQ · a11y · security · perf · compat · theming gallery · versioning · contributing. |
