...
| RD-08 | Reference, Guide curriculum & trust content | [RD-08](requirements/RD-08-reference-trust.md) | [guide-course-system](plans/guide-course-system/00-index.md) | Executing | 🔄 | 2026-07-29 | 32/246 tasks · Reactive state passed its independent quality review after all findings were corrected: 29/29 focused tests, docs-site typecheck, and `yarn verify` are green. Codex plugin is next. Separate Reference/trust planning remains for architecture · FAQ · a11y · security · perf · compat · theming gallery · versioning · contributing. |
