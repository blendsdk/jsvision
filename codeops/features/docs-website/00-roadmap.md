...
| RD-08 | Reference, Guide curriculum & trust content | [RD-08](requirements/RD-08-reference-trust.md) | [guide-course-system](plans/guide-course-system/00-index.md) | Executing | 🔄 | 2026-07-29 | 22/246 tasks · Layout's final-contract re-audit is 12/12 green with real resize/maximize/restore evidence; docs-site typecheck and `yarn verify` pass. Implementation hardening is next. Separate Reference/trust planning remains for architecture · FAQ · a11y · security · perf · compat · theming gallery · versioning · contributing. |
