...
| RD-08 | Reference, Guide curriculum & trust content | [RD-08](requirements/RD-08-reference-trust.md) | [guide-course-system](plans/guide-course-system/00-index.md) | Executing | 🔄 | 2026-07-30 | 62/246 tasks · Phase 8 Keyboard & clipboard reached its first green checkpoint: 26/26 independent specifications, docs-site typecheck, and authoritative verification pass. Hardening and promotion remain. Separate Reference/trust planning remains for architecture · FAQ · a11y · security · perf · compat · theming gallery · versioning · contributing. |
