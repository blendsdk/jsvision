...
| RD-08 | Reference, Guide curriculum & trust content | [RD-08](requirements/RD-08-reference-trust.md) | [guide-course-system](plans/guide-course-system/00-index.md) | Executing | 🔄 | 2026-07-29 | 38/246 tasks · Codex plugin reached its first green checkpoint: 8/8 specifications, 15/15 focused course/catalog tests, docs-site typecheck, plugin integrity, and `yarn verify` pass. Route hardening and promotion are next. Separate Reference/trust planning remains for architecture · FAQ · a11y · security · perf · compat · theming gallery · versioning · contributing. |
