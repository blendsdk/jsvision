...
| RD-08 | Reference, Guide curriculum & trust content | [RD-08](requirements/RD-08-reference-trust.md) | [guide-course-system](plans/guide-course-system/00-index.md) | Executing | 🔄 | 2026-07-30 | 200/246 tasks · Phase 25 Displaying untrusted text safely is complete after 34 focused checks, docs-site typecheck, production docs build, authoritative verification, and the permitted fix-scoped review; Phase 26 Accessibility & resilient interaction is next. Separate Reference/trust planning remains for architecture · FAQ · a11y · security · perf · compat · theming gallery · versioning · contributing. |
