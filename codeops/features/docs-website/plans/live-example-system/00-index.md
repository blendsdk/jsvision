...
> **Status**: Plan Created 📋 — ready for `exec-plan live-example-system`
...
| [03-06-testing-and-ci-integration.md](03-06-testing-and-ci-integration.md) | vitest project, two-tier harness, turbo wiring, typecheck tsconfig, CSP-compat, AGENTS.md note. |
