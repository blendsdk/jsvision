...
|----|-------|--------|------|-------|--------|--------------|-----------------|
| B-01 | UI small batch — Tree markers · duplicate-accelerator warning · Switch | GH #17 · #6 · #11 | [ui-small-batch](plans/ui-small-batch/00-index.md) | Done | ✅ | 2026-07-09 | Done — three additive enhancements: Tree markerStyle (#17) · duplicate-accelerator dev-warn via View.accelerators() seam (#6) · Switch over View (#11) · additive-only, preflight passed. |
