...
> **Last Updated**: 2026-07-25 02:20
> **Progress**: 0/63 tasks (0%)
...
- [ ] 1.1.1 [spec-author] Add public construction, lookup, fallback, and interpolation tests for ST-01–ST-08 — `packages/i18n/test/engine.spec.test.ts`, `packages/i18n/test/fixtures/catalogs.ts`
...
- [ ] 1.2.1 Scaffold package metadata, TypeScript/Vitest configuration, and browser-safe public entry — `packages/i18n/package.json`, `packages/i18n/tsconfig.json`, `packages/i18n/vitest.config.ts`
