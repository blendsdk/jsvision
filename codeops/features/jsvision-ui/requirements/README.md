...
> **Status**: Draft (RD-01…RD-06 + RD-10 + RD-11 + RD-13 shipped; RD-07 shipped; the high-value-control bucket (RD-12+) is being drafted as 6 sibling RDs by mechanism — **RD-14 (Input dropdowns) drafted**, RD-15…RD-19 queued; RD-08/RD-09 in backlog — see the roadmap)
> **Created**: 2026-06-29
...
| RD-15…RD-19 / RD-08 / RD-09 | *(queued/backlog — see roadmap)* | The remaining RD-12+ siblings: Tree (RD-15), Table/DataGrid (RD-16), Tabs (RD-17), ProgressBar/Spinner (RD-18), Surface (RD-19); plus Editor family (RD-08), files package (RD-09) | per phase |
