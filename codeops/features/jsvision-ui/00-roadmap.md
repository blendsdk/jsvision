...
> **Status**: In Progress
> **Created**: 2026-06-29
> **Last Updated**: 2026-07-02 (**RD-12+ high-value-controls set** — `make_requirements` sliced the bucket into 6 sibling RDs by mechanism (AR-125…AR-129); **RD-14 (Input dropdowns) + RD-15 (Tree) + RD-16 (Table/DataGrid) drafted** ✏️ with GATE-1 TV decodes + AR-130…AR-161 — the **MVP set (RD-14/15/16) is now fully drafted**; RD-17…RD-19 queued)
> **Progress**: 10 / 18 done (RD-01…RD-07, RD-10, RD-11, RD-13 ✅ · RD-14 + RD-15 + RD-16 ✏️ drafted — MVP set complete · RD-17…RD-19 + RD-08/RD-09 backlog)
