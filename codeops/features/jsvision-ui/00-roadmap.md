...
> **Status**: In Progress
> **Created**: 2026-06-29
> **Last Updated**: 2026-07-02 (**RD-12+ high-value-controls set opened** — `make_requirements` sliced the bucket into 6 sibling RDs by mechanism (AR-125…AR-129); **RD-14 (Input dropdowns — History + ComboBox) drafted** ✏️ with its GATE-1 History decode + AR-130…AR-140; RD-15…RD-19 queued)
> **Progress**: 10 / 18 done (RD-01…RD-07, RD-10, RD-11, RD-13 ✅ · RD-14 ✏️ drafted · RD-15…RD-19 + RD-08/RD-09 backlog)
...
| RD-15…RD-19 | High-value-controls siblings (RD-12+ set) | — | — | Backlog | ⬜ | 2026-07-02 | The remaining 5 RD-12+ siblings (sliced by mechanism, AR-126): **RD-15** Tree (`TOutlineViewer`) · **RD-16** Table/DataGrid (multi-column grid, realizes RD-11's deferred `numCols`, AR-103/104) · **RD-17** Tabs (new) · **RD-18** ProgressBar/Spinner (new) · **RD-19** Surface/SurfaceView (`TDrawSurface`). MVP = RD-15/16 (with RD-14); RD-17/18/19 later (AR-129). To be drafted one at a time via `make_requirements --continue`. Demo north-star (aspirational, AR-127): **clone `tvdemo`**. |
...
- **Recommended next:** **`make_plan RD-14`** (Input dropdowns) — the freshly-drafted MVP sibling, spec-first
  with a GATE-1 TV decode per component; or continue drafting the set with **`make_requirements --continue`**
  (RD-15 Tree). RD-07/RD-11/glyph-auto-swap plans also remain `exec_plan`-ready.
