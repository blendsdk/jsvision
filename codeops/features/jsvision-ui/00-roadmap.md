...
> **Status**: In Progress
> **Created**: 2026-06-29
> **Last Updated**: 2026-07-02 (RD-13 **EXECUTING** 🔄 — [runtime-hardening](plans/runtime-hardening/00-index.md): Phase 8/10 COMPLETE (controls minors HR-43…60, TV GATE), 105/120 tasks, spec-first per HR; full gate PASSED. Earlier: Phase 7 event/shell minors (TV GATE), Phase 6 reactive/view minors, Phase 5 core-engine minors, Phase 4 shell majors (TV GATE), Phase 3 lifecycle majors, Phase 2 core majors, Phase 1 critical trio)
