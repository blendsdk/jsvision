...
> **Status**: In Progress
> **Created**: 2026-06-29
> **Last Updated**: 2026-07-01 (RD-07 **preflighted** 🔎 — PASSED WITH NOTES, 0🔴/0🟠 + 3🟡 (fixed) + 2🔵; codebase-grounded, decoder-feasibility + TV citations independently verified)
> **Progress**: 8 / 11 done (RD-01 ✅, RD-02 ✅, RD-03 ✅, RD-04 ✅, RD-05 ✅, RD-06 ✅, RD-10 ✅, RD-11 ✅); RD-07 🔎 RD Preflighted
...
- **2026-07-01** — **RD-07 (Essential-control completions) drafted → preflighted** → stage `RD Preflighted`
  ...
  **feasibility** question — can the core decoder emit Shift/Ctrl-Shift arrows + Ctrl+A + Ctrl/Shift-Ins/Del?
  ...
  the portfolio row.
- **Recommended next:** **`make_plan RD-07`** — the RD is preflighted and gate-clean; plan it spec-first
  (per capability: spec oracles RED → implement → GREEN → impl tests) with a **GATE-1 TV decode** of
  `TInputLine` (selection/clipboard/`setCursor`) · `TPXPictureValidator` · `TMultiCheckBoxes`/`drawMultiBox`
  before writing draw/geometry. (RD-11 remains `exec_plan`-ready in parallel.)
