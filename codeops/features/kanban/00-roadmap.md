...
| RD-04 | Cards and presentation | [RD-04](requirements/RD-04-cards-presentation.md) | [Phase A slice](plans/phase-a-foundation/00-index.md), [Phase B](plans/phase-b-core-board/00-index.md) | Plan Preflighted | 🔬 | 2026-08-04 | Phase B preflight passed; later integration criteria stay open; depends on RD-01, RD-03 |
| RD-05 | Columns, swimlanes, and workflow policy | [RD-05](requirements/RD-05-columns-swimlanes-workflow.md) | [Phase A slice](plans/phase-a-foundation/00-index.md), [Phase B](plans/phase-b-core-board/00-index.md) | Plan Preflighted | 🔬 | 2026-08-04 | Phase B preflight passed; later integration criteria stay open; depends on RD-02–RD-04 |
| RD-06 | Focus, navigation, and selection | [RD-06](requirements/RD-06-focus-navigation-selection.md) | [Phase B](plans/phase-b-core-board/00-index.md) | Plan Preflighted | 🔬 | 2026-08-04 | Phase B preflight passed; Command-based Primary criteria remain open for RD-12; other later integration criteria stay open; depends on RD-03, RD-05 |
