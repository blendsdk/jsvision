...
- [x] 4.1.3 `[spec-author]` Add hysteresis, unknown-edge prefetch, collapsed-hover, and stale geometry/revision cases — `packages/kanban/test/pointer-drag.spec.test.ts` ✅ (completed: 2026-08-11 21:24)
