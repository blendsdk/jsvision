 ...
 * - `roleSnapshot !== null` ⇒ *roles* mode — an opaque 67-role theme (from an import or a literal
...
/** What the inspector currently edits — one of the 18 aliases, or one of the 67 concrete roles. */
