...
/**
 * Resolve a Files-owned accelerator label, recovering only an unsafe application override.
 *
 * @param i18n Service containing framework and application catalogs.
 * @param key Stable Files message key.
 ...
 */
export function filesAcceleratorLabel(i18n: I18n, key: string, english: string): string {
