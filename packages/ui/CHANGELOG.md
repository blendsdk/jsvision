...
## Fixed
- Fixed route anchored popups inside modals by registering popup input ownership with the event loop.
- Preserved modal isolation, dismissal, and focus restoration, addressing regressions in ComboBox, History, DatePicker, and ColorPicker components.
