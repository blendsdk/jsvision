 ...
 * helpers.
 *
 * `Window` and `frameTitleMinimumWidth` are part of the public `@jsvision/ui` API. The
 * `drawFrame`/`frameZoneAt` helpers are used internally by the desktop and are exported here for
