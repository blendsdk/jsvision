...
import type { FocusEvent, InputEvent, MouseEvent } from '@jsvision/core';
...
export interface KanbanDragHarness {
  /** Appends one sanitized mouse or focus event and ignores payload-bearing input. */
...
export type KanbanDragHarnessEvent = MouseEvent | FocusEvent;
...
export function createKanbanStandardPointerTrace(): KanbanSemanticPointerTrace {
  return Object.freeze({
    input:
      ...
      '\u001b[<0;3;5M\u001b[<32;5;5M\u001b[<32;21;7M\u001b[<0;21;7m',
  });
}
