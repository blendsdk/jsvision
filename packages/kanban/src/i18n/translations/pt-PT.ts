...
/** Phase D pt-PT overlay using the reviewed English fallback until native language review. */
export const kanbanPhaseDPtPT = createKanbanPhaseDTranslationCatalog('pt-PT');
