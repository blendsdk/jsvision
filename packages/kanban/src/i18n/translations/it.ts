...
/** Phase D it overlay using the reviewed English fallback until native language review. */
export const kanbanPhaseDIt = createKanbanPhaseDTranslationCatalog('it');
