...
/** Phase D fr overlay using the reviewed English fallback until native language review. */
export const kanbanPhaseDFr = createKanbanPhaseDTranslationCatalog('fr');
