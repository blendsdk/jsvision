...
export const API_MAP = [
  ...
  },
  {
    ...
    componentPage: '/components/data-grid/layout-and-rendering#cell-rendering',
  },
  {
    symbol: 'GridHeader',
    pkg: 'ui',
    apiPath: '/api/ui/classes/GridHeader',
    componentPage: '/components/data-grid/layout-and-rendering#column-geometry',
  },
  {
  ...
  },
  {
    ...
    componentPage: '/components/data-grid/editing-and-editors#edit-lifecycle',
  },
  {
    symbol: 'SortHeader',
    pkg: 'datagrid',
    apiPath: '/api/datagrid/classes/SortHeader',
    componentPage: '/components/data-grid/sorting-and-filtering#sorting',
  },
  {
    symbol: 'QuickFilterRow',
    pkg: 'datagrid',
    apiPath: '/api/datagrid/classes/QuickFilterRow',
    componentPage: '/components/data-grid/sorting-and-filtering#quick-filtering',
  },
  {
    symbol: 'FilterPopup',
    pkg: 'datagrid',
    apiPath: '/api/datagrid/classes/FilterPopup',
    componentPage: '/components/data-grid/sorting-and-filtering#advanced-filtering',
  },
  {
    symbol: 'ValueList',
    pkg: 'datagrid',
  ...
  },
  {
    ...
    componentPage: '/components/data-grid/footer-and-detail#aggregates-and-footer-bands',
  },
  {
    symbol: 'personalizeGrid',
    pkg: 'datagrid',
    apiPath: '/api/datagrid/functions/personalizeGrid',
    componentPage: '/components/data-grid/export-and-personalization#variants-and-personalization',
  },
  {
    symbol: 'Terminal',
    pkg: 'ui',
