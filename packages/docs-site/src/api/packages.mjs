...
// gate. It is exactly the publishable set (core, ui, files, forms, datagrid); the
 ...
 * @property {'core' | 'ui' | 'files' | 'forms' | 'datagrid'} name  Unscoped package name (and its api/<name>/ dir).
