...
| [ADR-009](ADR-009-bun-runtime-support.md)               | 2026-07-02 | First-class Bun runtime support (runtime + compile target only) | 🔬 Proposed |
| [ADR-010](ADR-010-code-editor-headless-architecture.md) | 2026-07-24 | Headless parser and document architecture for the code editor   | ✅ Accepted |
