/**
 * The "coming soon" roadmap panels — one per not-yet-shipped datagrid RD (RD-07…RD-14). Each is a
 ...
 * is replaced by the real demo cluster in the same navigator slot.
 *
...
/** The eight roadmap placeholders (RD-07…RD-14), in RD order. */
export const placeholders: readonly Story[] = [
  placeholderStory(
    'RD-07',
    'Columns & layout',
    'Resize, reorder, and hide columns, plus frozen pinned-panel columns and a sticky header.',
  ),
  placeholderStory(
    'RD-08',
    'Rows & selection',
    'Row selection, a checkbox column, a row gutter, and insert/delete/duplicate with a null policy.',
  ),
  placeholderStory(
    'RD-09',
    'Footer & aggregation',
    'A footer band with column aggregates (sum/avg/count) and master-detail row expansion.',
  ),
  placeholderStory(
    'RD-10',
    'Navigation',
