...
Changed:
- Pinned GroupBox notes to the released version to align with the updated distribution contract post v1.7.0 release.

## [1.7.0] - 2026-09-05

Changed:
- Updated storybook stories for Group Box component in the kitchen sink example.
- Improved test coverage for API reference and Group Box showcase examples.

## [Unreleased]

### Added

- Add the interactive GroupBox kitchen-sink story for alignment, nesting, reactivity, roles, clipping, focus, and shadow states.
