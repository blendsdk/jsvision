...
/**
 * Position a view absolutely at a canvas-relative rect and return it (chainable). The shared
 * placement helper every story uses, mirroring `controls-live`'s TV-coordinate layout.
 *
